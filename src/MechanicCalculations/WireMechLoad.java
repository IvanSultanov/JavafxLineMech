...
// Сх - коэффициент лобового сопротивления
    ...
    p2 = Kl * 0.9 * Math.PI * c * (KabDiam + c) / 1000; // даН/м;
    p3 = p1 + p2;
    p4 = alfa(q) * Cx  * Kh * q * KabDiam / 1000;
    p5 = alfa((q * 0.25)) * Cx * Kh * 0.25 * q * (KabDiam + 2 * c) / 1000;
    p6 = Math.sqrt(p1*p1 + p4*p4);
    p7 = Math.sqrt(p3*p3 + p5*p5);
